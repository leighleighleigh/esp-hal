...
pkgs.mkShell rec {
    ...
    buildInputs = [ esp-rs pkgs.rustup pkgs.espflash pkgs.rust-analyzer pkgs.pkg-config pkgs.stdenv.cc pkgs.bacon pkgs.systemdMinimal pkgs.just pkgs.lunarvim pkgs.inotify-tools ];
